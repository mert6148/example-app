        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="mt-6 text-center">
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white" data-i18n="app.name">Laravel Uygulaması</h1>
                    <h2 class="mt-2 text-xl text-gray-700 dark:text-gray-300" data-i18n="app.welcome">Hoşgeldiniz!</h2>
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 leading-relaxed max-w-2xl mx-auto" data-i18n="app.welcome_message">Merhaba, uygulamaya hoşgeldiniz!</p>
                </div>
